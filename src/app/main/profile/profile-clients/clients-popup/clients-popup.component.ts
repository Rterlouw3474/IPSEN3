...
export class ClientsPopupComponent implements OnInit {
  ...
  createClient(){
    ...
    const clientToPost = new Client(this.client.userEmail, this.client.clientName, this.client.clientPostalCode, this.client.clientHouseNumber, this.client.clientCity, this.client.clientCountry);
